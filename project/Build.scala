...
object ApplicationBuild extends Build {
  ...
  val appDependencies = Seq(
    ...
    ("org.reactivecouchbase" %% "reactivecouchbase-play" % "0.2").exclude("com.typesafe.play", "*"),
  ...
  val ezb_dal_play = Project(id="ezb-dal-play",
                             base=file("dal/ezb_dal_play/dal_bridge"))
                      .aggregate(ezb_dal)
                      .dependsOn(ezb_dal)
  ...
  ).aggregate(ezb_dal_play, ezb_dal)
   .dependsOn(ezb_dal_play, ezb_dal)
